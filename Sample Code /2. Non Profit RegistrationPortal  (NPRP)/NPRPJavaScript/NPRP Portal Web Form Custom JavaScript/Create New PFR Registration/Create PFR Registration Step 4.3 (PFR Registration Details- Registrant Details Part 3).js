...
function PageValidator(){
    ...
    /*******************Create new validator - Fund Raising License Suspension Information****************************/
          ...
          // Wire-up the click event handler of the validation summary link
          $("a[href='#crs_fundraisinglicenserevokedinfo']").on("click", function () { scrollToAndFocus('crs_fundraisinglicenserevokedinfo_label','crs_fundraisinglicenserevokedinfo'); });
          //Radio Button on change handler
    ...
    /*******************Create new validator - Voluntay Assurance Discontinuance Information****************************/
            var pfrq10yesValidator = document.createElement('span');
                ...
                // Wire-up the click event handler of the validation summary link
                $("a[href='#crs_voluntaryassuranceordiscontinuanceinfo']").on("click", function () { scrollToAndFocus('crs_voluntaryassuranceordiscontinuanceinfo_label','crs_voluntaryassuranceordiscontinuanceinfo'); });
                //Radio Button on change handler
