$(document).ready(function () {
    ...
    $("#its_complainant_hometelephonenumber, #its_complainant_workphonenumber, #its_business_telephonenumber, #its_business_telephonenumber2,#its_llu_paymentcompany_telephoneno, #its_llu_attorney_phone, #its_llu_paymentcompany_telephoneno, #its_llu_dealer_telephoneno ").keypress(function (e) {
