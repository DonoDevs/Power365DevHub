...
$(document).ready(function () {
    ...
    $('#signatureCertification').click(function () {
        ...
        //Set The Signature field to the Firstname +  Lastname
        var payrollOfficerSignature = $('#govmod_payrollofficersignature');
        payrollOfficerSignature.val($('#govmod_payrollofficerfirstname').val() + ' ' + $('#govmod_payrollofficerlastname').val());     
      });
