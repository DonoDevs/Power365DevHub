function PurchaseRequestOnload(){
    ...
    if(Xrm.Page.getAttribute("props_requestlessthan3000").getValue() == true)
     ...
     //Logic to show or hide the approval history section subgrid if the manager chooses approval on page load 
     ...
     //Logic to show or hide the denial history section subgrid if the manager chooses approval on page load 
     if(Xrm.Page.getAttribute("props_branchmanagerapproval").getValue() == '334440001')
     {
         Xrm.Page.ui.tabs.get("BranchManagerApproval").sections.get("BranchManagerApproval_DenialHistory").setVisible(true);

     }else{
         Xrm.Page.ui.tabs.get("BranchManagerApproval").sections.get("BranchManagerApproval_DenialHistory").setVisible(false);
     }
}
...
function PurchaseRequestOnChange(){
    ...
    if(Xrm.Page.getAttribute("props_requestlessthan3000").getValue() == true)
     ...
     //Logic to show or hide the denial history section subgrid if the manager chooses approval on change 
     if(Xrm.Page.getAttribute("props_branchmanagerapproval").getValue() == '334440001')
     {
         Xrm.Page.ui.tabs.get("BranchManagerApproval").sections.get("BranchManagerApproval_DenialHistory").setVisible(true);
